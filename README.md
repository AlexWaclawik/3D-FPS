...
- The player controller is a slightly modified version of a script which emulates Quake-style movement 
...
- Health is kept as a variable and initialized to "500." An area node and cylinder mesh are used as the hitbox of the player. 
...
- A basic user interface is present that displays the Player's current health and score. 
